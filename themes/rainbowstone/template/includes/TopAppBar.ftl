        ...
        <div id="main-navigation-bar">
            <div id="main-nav-bar-left">
                ...
                <#if uspErpTF?has_content>
                    <#if uspErpTF == "true">
                        <ul id="app-bar-list">
                            <!-- USP ERP get Permission Start-->
                            <#assign appCount = 0>
                            <#assign moreApp = false>
                            <#list displayApps as display>
                                <#assign thisApp = display.getContextRoot()>
                                <#if thisApp == contextPath || contextPath + "/" == thisApp>
                                    <#assign uspErpInfo = display>
                                    <#break>
                                </#if>
                            </#list>
                            ...
                            <#list mainMenuList as display>
                                ...
                                <#assign permissions = uspErpInfo.getBasePermission()>
                                ...
                                <#if permission == true>
                                    ...
                                    <#if appCount<=appMax>
                                        ...
                                        <a href="${thisURL}${StringUtil.wrapString(externalKeyParam)}"<#if uiLabelMap?exists> title="${uiLabelMap[display.title]}">${uiLabelMap[display.title]}<#else> title="${display.title}">${display.title}</#if></a>
                                        <#if selected>
                                        ...
                                        <div id="more-app" <#if !alreadySelected>class="selected"</#if>>
                                            ...
                                            <ul id="more-app-list">
                                                ...
                                                <li class="app-btn-sup<#if selected> selected</#if>">
                                                    <a class="more-app-a" href="${thisURL}${StringUtil.wrapString(externalKeyParam)}"<#if uiLabelMap?exists> title="${uiLabelMap[display.title]}">${uiLabelMap[display.title]}<#else> title="${display.title}">${display.title}</#if></a>
                                                </li>
                                </#if>
                                <#assign appCount = appCount + 1>
                            </#if>
