        ...
        <#if uspErpTF?has_content>
            <#if uspErpTF == "true">
                ...
                <#list mainMenuList as display>
                    ...
                    <a href="${thisURL}${StringUtil.wrapString(externalKeyParam)}"<#if selected> class="selected"</#if><#if uiLabelMap??> title="${uiLabelMap[display.title]}">${uiLabelMap[display.title]}<#else> title="${display.title}">${display.title}</#if></a>
